# Contributing to Motionrack

Thank you for considering contributing to Motionrack. We appreciate your interest and support in making this project better! By contributing, you help us improve the project and create a more inclusive and vibrant community.
...
1. Check the [GitHub Issues](https://github.com/demjhonsilver/motionrack/issues) to see if the issue has already been reported.
...
1. Check the [GitHub Issues](https://github.com/demjhonsilver/motionrack/issues) to see if your enhancement idea has been proposed.
...
git clone https://github.com/demjhonsilver/Motionrack.git
...
3. Open a pull request on the [GitHub repository](https://github.com/demjhonsilver/motionrack/pulls).
...
Thank you for contributing to Motionrack! Your help is invaluable, and we look forward to working with you.
